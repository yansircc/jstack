					...
					<div className="flex flex-col gap-8">
						<blockquote>
							<p className="text-xl/8 font-light text-muted-light italic">
								"JStack is built on top of some of the highest quality web
								software. It's the framework I wish I'd had when I started —
								crafted from years of experience building production Next.js
								apps.{" "}
								<span className="text-brand-400">
									Lambos are not just for PHP devs anymore :^)
								</span>
								"
							</p>
						</blockquote>
